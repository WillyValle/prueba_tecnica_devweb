  ...
  <div class="card-body">
    ...
    <div>
      <button id="btnToggleCategoria" class="btn btn-primary btn-toggle-form" onclick="toggleFormulario('Categoria', 'Agregar Nueva Categoría', 'btn-primary')">
        <i class="fas fa-plus"></i> Agregar Tipo de Empleado
      </button>
    </div>
    <br>
    ...
    <div id="formularioCategoria" class="card card-primary formulario-expandible" style="display: none;">
      <div class="card-header">
        <h3 class="card-title">Agregar Tipo de Empleado</h3>
      </div>
      <form action="?c=roleemployee&a=Guardar" method="POST">
        <div class="card-body">
          <div class="form-group">
            <input class="form-control" id="ID_ROLE_EMPLOYEE" type="hidden">
          </div>
          <div class="form-group">
        ...
        <div class="card-footer">
          ...
          <button type="button" class="btn btn-secondary ml-2" onclick="cancelarFormulario('Categoria', 'Agregar Nuevo Rol de Empleado', 'btn-primary')">Cancelar</button>
        </div>
      </form>
    </div>
