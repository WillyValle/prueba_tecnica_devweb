  ...
  <div class="card-body">
    ...
    <div>
      <button id="btnToggleCategoria" class="btn btn-primary btn-toggle-form" onclick="toggleFormulario('Categoria', 'Agregar Nueva Categoría', 'btn-primary')">
        <i class="fas fa-plus"></i>Agregar Método de Aplicación
      </button>
    </div>
    <br>
    ...
    <div id="formularioCategoria" class="card card-primary formulario-expandible" style="display: none;">
      <div class="card-header">
        <h3 class="card-title">Agregar Método de Aplicación</h3>
      </div>
      <form action="?c=applicationmethod&a=Guardar" method="POST">
        <div class="card-body">
          <div class="form-group">
            <input class="form-control" id="ID_APPLICATION_METHOD" type="hidden">
          </div>
          <div class="form-group">
            <label for="nombre_metodo">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="descripcion_metodo" name="descripcion_metodo" rows="3" placeholder="Ingrese la descripción"></textarea>
          </div>
        </div>
        <div class="card-footer">
          <button type="submit" class="btn btn-primary">Guardar</button>
          <button type="button" class="btn btn-secondary ml-2" onclick="cancelarFormulario('Categoria', 'Agregar Nuevo Método', 'btn-primary')">Cancelar</button>
        </div>
      </form>
    </div>
